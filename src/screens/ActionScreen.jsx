...
export default function ActionScreen() {
  ...
  const movie = films.action[0]; // On garde la logique d'accès au premier film
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.LikeButton,
            {
              backgroundColor: favorite ? "#FF6347" : "none",
        ...
        >
          <Text style={[styles.backButtonText, {color: favorite ? "white" : "#FF6347"}]}>Liker ce Film</Text>
        </TouchableOpacity>
      </ScrollView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    shadowColor: "#FF6347", // Ombre couleur "Action"
  ...
  directorName: {
    color: "#FF6347", // Couleur "Action" pour mettre en valeur le réalisateur
    fontSize: 16,
    fontWeight: "600",
  },
  divider: {
  ...
  backButton: {
    borderColor: "#FF6347", // Bordure couleur "Action"
    borderWidth: 2,
    borderRadius: 25,
    paddingVertical: 12,
