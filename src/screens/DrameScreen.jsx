...
export default function ActionScreen() {
  ...
  const movie = films.drame[0]; // On garde la logique d'accès au premier film
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.LikeButton,
            {
              backgroundColor: favorite ? "#708090" : "none",
        ...
        >
          <Text style={[styles.backButtonText, {color: favorite ? "white" : "#708090"}]}>Liker ce Film</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    shadowColor: "#708090", // Ombre couleur "Action"
  ...
  directorName: {
    color: "#708090", // Couleur "Action" pour mettre en valeur le réalisateur
    fontSize: 16,
    fontWeight: "600",
  },
  divider: {
  ...
  backButton: {
    borderColor: "#708090", // Bordure couleur "Action"
    borderWidth: 2,
    borderRadius: 25,
    paddingVertical: 12,
