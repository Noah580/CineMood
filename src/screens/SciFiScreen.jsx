...
export default function ActionScreen() {
  ...
  const movie = films.sciencefiction[0]; // On garde la logique d'accès au premier film
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.LikeButton,
            {
              backgroundColor: favorite ? "#1E90FF" : "none",
        ...
        >
          <Text style={[styles.backButtonText, {color: favorite ? "white" : "#1E90FF"}]}>Liker ce Film</Text>
        </TouchableOpacity>
      </ScrollView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    shadowColor: "#1E90FF", // Ombre couleur "Action"
  ...
  directorName: {
    color: "#1E90FF", // Couleur "Action" pour mettre en valeur le réalisateur
    fontSize: 16,
    fontWeight: "600",
  },
  divider: {
  ...
  backButton: {
    borderColor: "#1E90FF", // Bordure couleur "Action"
    borderWidth: 2,
    borderRadius: 25,
    paddingVertical: 12,
