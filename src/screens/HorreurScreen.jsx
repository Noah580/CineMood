...
export default function ActionScreen() {
  ...
  const movie = films.horreur[0]; // On garde la logique d'accès au premier film
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.LikeButton,
            {
              backgroundColor: favorite ? "#DC143C" : "none",
        ...
        >
          <Text style={[styles.backButtonText, {color: favorite ? "white" : "#DC143C"}]}>Liker ce Film</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    shadowColor: "#DC143C", // Ombre couleur "Action"
  ...
  directorName: {
    color: "#DC143C", // Couleur "Action" pour mettre en valeur le réalisateur
    fontSize: 16,
    fontWeight: "600",
  },
  divider: {
  ...
  backButton: {
    borderColor: "#DC143C", // Bordure couleur "Action"
    borderWidth: 2,
    borderRadius: 25,
    paddingVertical: 12,
